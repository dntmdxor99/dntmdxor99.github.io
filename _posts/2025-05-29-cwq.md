...
We evaluate CWQ and CWQ+ against the AWQ baseline under varying bit-width budgets on Llama-2-7B and Llama-2-13B models.  Table 2 reports perplexity on Wikitext2 and C4, along with the average zero-shot accuracy across nine benchmark tasks (Arc-easy, Arc-challenge, BoolQ, HellaSwag, LAMBADA_openai, OpenBookQA, PIQA, Social_IQA, WinoGrande).  Memory usage is shown in megabytes.
